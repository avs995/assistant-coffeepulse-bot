...
- `/stats month` — статистика за последние 30 дней
...
Статистика показывает количество лидов по статусам, количество контактов, ответов, клиентов, конверсию в ответ и конверсию в клиента.
